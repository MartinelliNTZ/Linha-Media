...
class SimpleConnectionJudge:
    ...
    def generate_nearest_with_orphans(base_geom, target_geom, target_n, resolve_endpoints=True):
        ...
        for b_idx, b_pt in enumerate(base_verts):
            ...
            if not nearest_g.isEmpty():
                ...
                t_idx = SimpleConnectionJudge._find_nearest_vertex_index(target_pt, target_verts)
    ...
    def solve_nearest_with_criteria(geom1, geom2, criteria_idx, target_n, resolve_endpoints=True):
        ...
        if use_g1_as_base:
            results = SimpleConnectionJudge.generate_nearest_with_orphans(g1, g2, target_n, resolve_endpoints)
            ...
            results = SimpleConnectionJudge.generate_nearest_with_orphans(g2, g1, target_n, resolve_endpoints)
