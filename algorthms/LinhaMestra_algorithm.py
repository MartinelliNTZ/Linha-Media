...
class LinhaMestraAlgorithm(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        return self.tr(
            ...
            "  Camada vetorial de linhas com a 1ª feição.\n"
            "  Se a 2ª camada não for informada, esta deve\n"
            "  conter exatamente 2 feições.\n"
            "\n"
            "▶ Segunda Camada (opcional):\n"
            "  Camada com a outra feição. Quando preenchida,\n"
            "  cada camada deve ter exatamente 1 feição.\n"
            "\n"
            "▶ Número de Partições (10 a 999.999):\n"
            "  Quantos segmentos dividir as linhas para o\n"
            "  cálculo. Quanto maior, mais preciso. O valor\n"
            "  efetivo é max(partições, vértices das linhas).\n"
            "\n"
            "▶ Estilo de Conexão:\n"
            "  • Proximidade — conecta pontos mais próximos\n"
            "  • Perpendicular — conexões em ângulo reto\n"
            "  • Conexão Direta — liga pontos interpolados\n"
            "  • Espaçamento Fixo — intervalos regulares (m)\n"
            "\n"
            "▶ Estilo da Linha Mestra:\n"
            "  • Interpolação — ponto médio entre pares\n"
            "  • Proximidade — média espacial das conexões\n"
            "  • Espaçamento Fixo — pontos médios 1:1\n"
            "\n"
            "▶ Critério de Proximidade:\n"
            "  • Ponta→Meio (Sincronismo)\n"
            "  • Menor/Maior Tamanho\n"
            "  • Menor/Maior Ângulo\n"
            "\n"
            "▶ Resolver órfãos das pontas:\n"
            "  Corrige pontas sem conexão no método\n"
            "  Proximidade.\n"
            "\n"
            "▶ Espaçamento Fixo (metros):\n"
            "  Distância entre conexões no modo 1:1.\n"
            "\n"
            "▶ Redução para Filtro de Cruzamento (avançado):\n"
            "  Fator 0-1 para eliminar conexões que se\n"
            "  cruzam. 1 = sem redução.\n"
            "\n"
            "── FUNCIONAMENTO TÉCNICO ──\n"
            "\n"
            "1. Extrai 2 feições e valida as entradas.\n"
            "2. Alinha geometrias (mesma direção).\n"
            "3. Define target_n = max(partições, vértices).\n"
            "4. Dispara pipelines conforme estilos:\n"
            "   • Proximidade → ConnectionJudge\n"
            "   • Interpolação → generate_linhamestra_elements\n"
            "   • 1:1 → generate_1to1_connections\n"
            "5. Gera Linha Mestra pelos pontos médios.\n"
            "6. Escreve 2 camadas de saída:\n"
            "   • Linha Mestra (id_segmento, dist_mae)\n"
            "   • Conexões (id_conexao, id_pai, id_mae, id_origem)"
        )
